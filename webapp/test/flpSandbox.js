		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#stockanalytics-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"stockanalytics-display": {
								"semanticObject": "stockanalytics",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=stockanalytics",
									"url": sap.ui.require.toUrl("stockanalytics")
								}
							}
						}
					}
